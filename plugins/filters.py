    ...
    if query.message.reply_to_message.from_user.id == query.from_user.id:
        if query.data == "back1":
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("🚸 JOIN OUR CHANNEL 🚸", url="https://t.me/mizolibrary")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("🚸 SUPPORT 🚸", url="https://t.me/mp3andvideodownloader")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("SOURCE CODE", url="https://github.com/https://github.com/RSR-Downloader/rsrautofilter")]
            ])
